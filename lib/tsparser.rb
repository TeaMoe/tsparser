module TSparser
  ...
  DEFINITION_FILES =
    ['/descriptor.rb',
     '/descriptor_list.rb',
     '/eit_event.rb',
     '/service_description.rb',
     '/event_information_section.rb',
     '/service_description_section.rb',
     '/event_list.rb',
     '/service_description_list.rb',
     '/transport_packet.rb',
     '/arib_duration.rb',
     '/arib_time.rb',
     '/arib_string.rb']
